...
from blog.models import Article, Category, Carousel, Nav, Column, News,Story,Note,RelStoryNote
...
class RelStoryNoteAdmin(admin.ModelAdmin):
    list_display = ('story','note')

admin.site.register(Story,StoryAdmin)
admin.site.register(Note,NoteAdmin)
admin.site.register(RelStoryNote,RelStoryNoteAdmin)